...
|--------------------------|-----------------|
| **Attributes**           |  🟧 **Partial** |
| **Player Managemnet**    |  🟧 **Partial** |
| **TP Utilities**         |  ✅ **Full**    |
| **Simplified Gamerules** |  🟥 **None**    |


| Command Names        | In Game Command | Plugin version     |
|----------------------|-----------------|--------------------|
| Size                 | /size           | **1.0** or later   |
| Health               | /health         | **1.0** or later   |
| Speed                | /speed          | **1.1** or later   |
| Heal                 | /heal           | **1.1** or later   |
| Invincible           | /god            | **1.1** or later   |
| TP Here              | /tphere         | **1.1** or later   |
| TP All               | /tpall          | **1.1** or later   |
| All of the Gamerules | /rule           | **Will be in 2.0** |
...
_The GitHub Page might be out of sync from the plugin on modrinth because i dont always update the repo!_
