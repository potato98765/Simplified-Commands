            ...
            if (sub.equalsIgnoreCase("set")) {
                try {
                    ...
                    Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
                            "attribute " + target + " minecraft:scale base set " + scale);
                ...
                Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
                        "attribute " + valueOrTarget + " minecraft:scale base set 1");
        ...
        public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
            ...
            if (sub.equalsIgnoreCase("set")) {
                try {
                    ...
                    Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
                            "attribute " + target + " minecraft:max_health base set " + amount);
                ...
                Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
                        "attribute " + valueOrTarget + " minecraft:max_health base set 20");
